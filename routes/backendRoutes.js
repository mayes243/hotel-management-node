...
// Authentication
router.route("/login").get(backendControllers.getLogin).post(auth);

router.use(authControllers.adminAuth);

router.use(backendControllers.globalAdminVariables);

router.route("/logout").get(authControllers.adminLogout);
...
router.route("/profile").get(backendControllers.getProfileSettings);

router.put(
  "/profile/:id",
  backendControllers.uploadSingle,
  backendControllers.submitProfileSettings
);
...
router.put(
  "/site-settings/:id",
  backendControllers.uploadSiteSettings,
  backendControllers.submitSiteSettings
);
...
router.route("/gallery").get(galleryControllers.getGallery);
